...
export default function GuinnessRecord() {
    ...
    return (
        <section className="w-full py-16">
            ...
            >
                {/* Background cultural decorations */}
                <div className="absolute top-0 left-0 w-64 opacity-10 -rotate-12 translate-x-[-20%] translate-y-[-20%]">
                    <SectionDecoration 
                ...
                <div className="absolute bottom-0 right-0 w-64 opacity-10 rotate-12 translate-x-[20%] translate-y-[20%]">
                    <SectionDecoration 
